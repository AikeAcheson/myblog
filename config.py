...
class Config:
    ...
    MYBLOG_MAIL_SENDER = 'Myblog Admin <mingmingli_site@163.com>'
...
class ProductionConfig(Config):
    ...
    def init_app(cls, app):
        ...
        mail_handler = SMTPHandler(
            ...
            fromaddr=cls.MYBLOG_MAIL_SENDER,
            toaddrs=[cls.MYBLOG_ADMIN],
            subject=cls.MYBLOG_MAIL_SUBJECT_PREFIX + ' Application Error',
